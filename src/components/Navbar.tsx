...
import { Menu, X, User, Video, Radio, Music, Settings } from "lucide-react";
...
const Navbar = () => {
  ...
  const navItems = [
    { name: "Home", path: "/", icon: <Radio className="h-4 w-4" /> },
    { name: "Services", path: "/services", icon: <Music className="h-4 w-4" /> },
  ...
  return (
    <nav className="bg-background/95 backdrop-blur-sm border-b border-border fixed w-full z-50 transition-all duration-300">
